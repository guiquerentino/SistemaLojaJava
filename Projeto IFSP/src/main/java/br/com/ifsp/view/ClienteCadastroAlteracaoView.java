...
public class ClienteCadastroAlteracaoView extends javax.swing.JInternalFrame {
    ...
    private void lbPreencherAutomaticoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbPreencherAutomaticoMouseClicked
        txtNome.setText("Guilherme Querentino");
        txtCpf.setValue("519.444.639-11");
        txtDataNascimento.setValue("08/11/2002");
        rdbMasculino.setSelected(true);
        cboEstadoCivil.setSelectedIndex(1);
        cboEstado.setSelectedIndex(1);
        txtCidade.setText("Guarulhos");
        txtBairro.setText("Vila Fatima");
        txtLogradouro.setText("Av.Nossa Senhora de Fátima");
        txtNumero.setText("223");
